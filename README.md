...
自动化测试包括 8 个测试文件、60 个测试用例，并覆盖两层页面树、腾讯响应省略当前页外壳且仅含一个子页面的情况、根页面追加、子页面锚点写入与空子页面跳过、含花括号的 Markdown/LaTeX 数学公式、超过 20 个 Block、最近文档分页、远端冲突、恢复路径、JSON/SSE MCP 响应、图片和 PDF。发布前仍需在真实 Obsidian Vault 与腾讯测试文档中执行人工验收。
